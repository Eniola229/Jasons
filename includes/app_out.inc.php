...
class UserApproval extends Dbh {
    public function approveUser($email) {
        try {
            ...
            $stmt = $pdo->prepare("UPDATE outreaches_app SET approved = '1' WHERE email = :email");
    ...
    protected function sendEmail($email) {
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Congratulations | Jasons OutReach';
            $email_template = "You have been approved to attend the Outreach you applied for!!!" .
                "<h4>Kindly Message Co-Ordinator to start the process!!!</h4>" .
                 "<a href=''>Login Here</a>" .
                 "<br><br>" .
                "<b>Jasons Team</b>";
